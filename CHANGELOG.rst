...
Release v2.3.0 of the ``ansible-aci`` collection on 2022-10-22.
...
- Fix HTTP status returned by aci_rest (#279) Co-authored-by: Fraser Henshaw <Fraser.Henshaw@onyxnetworks.co.uk>
