...
Release v2.9.0 of the ``ansible-aci`` collection on 2024-03-27.
...
- Add access spine interface selector and port block binding in aci_access_port_block_to_access_port and Update test file. Add few changes to aci_access_spine_interface_selector module.
- Add aci_access_spine_interface_selector as a new Module. Modify aci_access_port_block_to_access_port module to add port block to access spine interface selector.
...
- Add aci_node_block as a new module. Modify child class node block conditions to be optional in aci_switch_leaf_selector.
...
- Add support for multi level nested dictionaries in aci_listify filter plugin
...
- Added No-verification flag option to reduce the number of API calls. - If true, a verifying GET will not be sent after a POST update to APIC. - Added test cases to multiple modules to test no-verification flag option.
- Added below modules and tests for Fabric External Connection Policies and its child modules.
...
- Modify test cases for spine switch policies and spine interface profile. Update Module name for aci_access_spine_interface_selector_to_spine_switch_profile. Update aci_access_spine_switch_selector module.
- Remove storm_control_types as input. Now deduced from type configuration inputs in aci_interface_policy_storm_control.
...
- Update python module and integration test file for aci_interface_policy_storm_control.
