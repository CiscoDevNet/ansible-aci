...
short_description: Manage Route Control Profile objects (rtctrl:Profile)
description:
- Manage Route Control Profile on Cisco ACI fabrics.
options:
  tenant:
    description:
  ...
  l3out:
    ...
    - If this is omitted, the profile will be created directly under the tenant instead of within the L3out.
    type: str
    aliases: [ l3out_name ]
  description:
    description:
...
- name: Delete Route Control Profile
  cisco.aci.aci_route_control_profile:
    host: apic
    username: admin
    password: SomeSecretPassword
...
- name: Query Route Control Profile
  cisco.aci.aci_route_control_profile:
    host: apic
    username: admin
    password: SomeSecretPassword
