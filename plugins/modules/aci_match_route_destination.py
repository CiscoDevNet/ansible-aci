...
def main():
    ...
    argument_spec.update(
        ...
        ip=dict(type="str", aliases=["name", "match_rule_name"]),
        aggregate=dict(type="str", choices=["extended", "regular"]),
        from_prefix_lenght=dict(type="str"),
        to_prefix_lenght=dict(type="str"),
    ...
    module = AnsibleModule(
        ...
        required_if=[
            ["state", "absent", ["ip", "tenant"]],
            ["state", "present", ["ip", "tenant"]],
        ],
    )
