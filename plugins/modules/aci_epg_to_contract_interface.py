...
options:
  ...
  contract:
    description:
    - Name of the Contract interface, which is exported to the tenant with the scope of 'Global'.
    type: str
...
def main():
    ...
    argument_spec.update(
        ...
        contract=dict(type='str', aliases=['contract_interface_name']),  # Not required for querying all objects
    ...
    module = AnsibleModule(
        ...
        required_if=[
            ['state', 'absent', ['tenant', 'ap', 'epg', 'contract', 'priority']],
            ['state', 'present', ['tenant', 'ap', 'epg', 'contract', 'priority']],
        ],
    )
    ...
    aci.construct_url(
        ...
        subclass_3=dict(
            ...
            aci_rn='rsconsIf-{0}'.format(contract),
