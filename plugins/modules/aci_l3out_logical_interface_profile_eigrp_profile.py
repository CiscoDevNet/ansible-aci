...
DOCUMENTATION = r"""
---
module: aci_l3out_logical_interface_profile_eigrp_profile
short_description: Manage Layer 3 Outside (L3Out) EIGRP interface profile (eigrp:IfP)
description:
- Manage L3Out logical interface profile EIGRP profile on Cisco ACI fabrics.
options:
  tenant:
    description:
...
EXAMPLES = r"""
- name: Add a new interface profile EIGRP profile
  cisco.aci.aci_l3out_logical_interface_profile_eigrp_profile:
    host: apic
    username: admin
...
- name: Delete an interface profile EIGRP profile
  cisco.aci.aci_l3out_logical_interface_profile_eigrp_profile:
    host: apic
    username: admin
    password: SomeSecretPassword
...
- name: Query an interface profile EIGRP profile
  cisco.aci.aci_l3out_logical_interface_profile_eigrp_profile:
    host: apic
    username: admin
    password: SomeSecretPassword
